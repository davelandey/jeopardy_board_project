...
//! This is to target a specific values - access the first object in array - in this example it could be changed to question or answer

// TIP: nature questions 0 - 4 = first round, and 5 - 9 for second round
// use getElementbyClassName = HTMLcollection

// use .Map (array.prototype.map)
...
//Filters:
    // Questions:
let natureQuestions = placeholderQuestions.filter((question) => question.category === "Nature");
...
let animalsQuestions = placeholderQuestions.filter((question) => question.category === "Animals");
console.log(animalsQuestions);
let computerQuestions = placeholderQuestions.filter((question) => question.category === "Computers");
console.log(computerQuestions);
let mythologyQuestions = placeholderQuestions.filter((question) => question.category === "Mythology");
let historyQuestions = placeholderQuestions.filter((question) => question.category === "History");
let generalQuestions = placeholderQuestions.filter((question) => question.category === "General");
